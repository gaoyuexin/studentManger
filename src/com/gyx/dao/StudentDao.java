...
public class StudentDao extends BaseDao<Student>{
    ...
    public List<Student> findAllStudent() {
        return moreLine("select * from student",Student.class);
    }
    ...
    public int updateStudent(Student student) {
        return dml("update student set sname = ?, gender = ?,hobby = ?,degree = ?,mark = ? where sid = ?",student.getSname(),student.getGender(),student.getHobby(),student.getDegree(),
